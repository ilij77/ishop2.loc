                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <a href="<?=ADMIN?>/filter/group-add" class="btn btn-primary">
                            <i class="fa fa-fw fa-plus  text-danger"></i>Добавить группу
                        </a>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <?php foreach ($attrs_group as $item):?>
                                ...
                                <td><a  href="<?= ADMIN;?>/filter/group-edit?id=<?=$item->id;?>">
                                        <i class="fa fa-fw fa-pencil  text-danger"></i> </a>
                                <a class="delete text-danger" href="<?= ADMIN;?>/filter/group-delete?id=<?=$item->id;?>">
