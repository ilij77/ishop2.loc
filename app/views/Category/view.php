                            ...
                            <div class="col-md-4 product-left p-left">
                                <div class="product-main simpleCart_shelfItem">
                                    ...
                                    <div class="product-bottom">
                                        <h3><?=$product->title?></h3>
                                        <p>Explore Now</p>
                                        <h4><a class="add-to-cart-link" data-id="<?= $product->id;?>
" href="cart/add/?id=<?= $product->id;?>"><i></i></a> <span class=" item_price"><?=$curr['symbol_left']; ?>
                                    ...
                                    <div class="srch srch1">
                                        <?php if ($product->old_price):  ?>
                                            <span>Sale <?php echo round((1-$product->price / $product->old_price)*100,1);?>%</span>
                                        <?php  endif;?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="text-center">
                            <p><?=count($products)?> товаров из <?=$total?> </p>
